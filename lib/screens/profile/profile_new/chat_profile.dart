...
class ChatProfileScreen extends StatelessWidget {
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            friend?.user?.about != 'null' ? friend?.user?.about ?? 'NA' : 'NA',
                            maxLines: 7,
                            style: const TextStyle(
                                color: Colors.white70,
                                fontWeight: FontWeight.w600),
                          ...
                          FutureBuilder(
                            ...
                            builder: (BuildContext context, AsyncSnapshot<List<Artists>?> snapshot) {
  ...
  Future<List<Artists>?> getArtistsList() async {
    ...
    if (response?.statusCode == 200) {
      ...
      Profile? profile = res['user'] != null ? Profile.fromJson(res['user']) : null;
